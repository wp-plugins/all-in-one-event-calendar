...
/* eventpromote-custom-post-status.twig */
class __TwigTemplate_db269ce29aefe7d64ca423169a13567df4a39c7231aac1d293f1db2fab07e401 extends Twig_Template
{
...
\t\t\$( \"select#post_status\" ).append(\"<option value='";
        // line 3
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["post_status"]) ? $context["post_status"] : null), "ident"), "html", null, true);
        echo "' ";
        if ((isset($context["selected"]) ? $context["selected"] : null)) {
            echo " selected='selected'";
        }
        echo ">";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["post_status"]) ? $context["post_status"] : null), "label"), "html", null, true);
        echo "</option>\");
\t\t";
        // line 4
        if ((isset($context["selected"]) ? $context["selected"] : null)) {
            echo "\$(\".misc-pub-section label\").append(\"<span id='post-status-display'> ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["post_status"]) ? $context["post_status"] : null), "label"), "html", null, true);
            echo "</span>\");";
        }
        // line 5
...
";
    ...
    {
        return "eventpromote-custom-post-status.twig";
    }
