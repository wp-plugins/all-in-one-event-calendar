...
class __TwigTemplate_b7740cbe0a1d12ad983e03d0c9bb369ea941ba9f941c5cf86a696dff0bf8fbca extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div id=\"ai1ec-box-oauth-provider-twitter\" class=\"misc-pub-section timely\">
\t<label for=\"ai1ec-twitter-post\">
\t\t<input class=\"ai1ec-checkbox-inline\" type=\"checkbox\" value=\"1\" ";
        // line 3
        echo twig_escape_filter($this->env, (isset($context["checked"]) ? $context["checked"] : null), "html", null, true);
        echo " name=\"ai1ec-twitter-post\" id=\"ai1ec-twitter-post\" ";
        echo twig_escape_filter($this->env, (isset($context["disabled"]) ? $context["disabled"] : null), "html", null, true);
        echo " />
\t\t<i class=\"ai1ec-fa ai1ec-fa-twitter-square ai1ec-fa-lg\"></i>
\t\t";
        // line 5
...
\t</label>
    ...
    {
        return "ai1ecti-post-meta-box.twig";
    }
